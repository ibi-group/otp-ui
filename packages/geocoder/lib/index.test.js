...
describe("geocoder", () => {
  ...
  .get(`${basePeliasPath}autocomplete`).query(true).replyWithFile(200, mockResponsePath("pelias", "autocomplete-response.json")) // reverse
  .get(`${basePeliasPath}search`).query(true).replyWithFile(200, mockResponsePath("pelias", "search-response.json")) // search
